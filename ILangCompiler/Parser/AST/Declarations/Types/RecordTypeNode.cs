...
namespace ILangCompiler.Parser.AST.Declarations.Types
{
    public class RecordTypeNode : ITypeNode
    {
        ...
        public static Either<ParseException, Pair<List<IToken>, RecordTypeNode>> Parse(List<IToken> tokens, IScopedTable<IEntityType, string> parentTypeTable)
        {
            ...
            while (true)
            {
                var maybeVariableDeclaration = VariableDeclarationNode.Parse(tokens, parentTypeTable);
